  ...
  return (
    <section className="bg-white w-[99%] overflow-hidden h-screen flex justify-center items-center dark:bg-gray-900 bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/hero-pattern.svg')] dark:bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/hero-pattern-dark.svg')]">
      <div className="relative z-10 max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-16">
        <a
          href="#"
          className="inline-flex items-center justify-between px-1 py-1 text-sm text-blue-700 bg-blue-100 rounded-full pe-4 mb-7 dark:bg-blue-900 dark:text-blue-300 hover:bg-blue-200 dark:hover:bg-blue-800"
        >
        ...
        <NavLink to="/login">
          <button
            type="submit"
            className="text-white text-center w-64 p-5  end-2.5 bottom-2.5 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
          >
            Login
          </button>
        </NavLink>
