...
const PeriodicSQReportsTable = React.forwardRef(
  ({ quotations, customer, quoDate }: any, ref: any) => {
    const rowsPerPage = 5;
      ...
      <>
        <div ref={ref}>
          <div className="flex justify-between w-full p-3">
            <div className="text-lg uppercase font-lato-bold">{customer}</div>
            <div className="text-lg uppercase font-lato-bold">{quoDate}</div>
          </div>
          <Table>
            <TableHeader>
              <TableRow>
